...
\begin{cventries}
  ...
  \cventry
    ...
    {British Telecom (formerly, IP Trade)} % Organization
    {Liège, Belgium} % Location
    {Sept. 2016 - Jan. 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item{Participated in the development and improvement of an IP-based desktop telephony application (\colorhref[material-indigo]{https://www.globalservices.bt.com/en/solutions/products/trading-devices-and-applications}{TouchPro}) written in C++/Qt/QML.}
